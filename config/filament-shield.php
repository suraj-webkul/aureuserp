    ...
    */
    ...
    'resources' => [
        ...
        'manage'  => [
            ...
            \Webkul\TimeOff\Filament\Clusters\MyTime\Resources\MyTimeOffResource::class                                   => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any', 'approve'],
            \Webkul\TimeOff\Filament\Clusters\MyTime\Resources\MyAllocationResource::class                                => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any', 'approve'],
            \Webkul\TimeOff\Filament\Clusters\Management\Resources\AllocationResource::class                              => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any', 'approve'],
            \Webkul\TimeOff\Filament\Clusters\Management\Resources\TimeOffResource::class                                 => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any', 'approve'],
            \Webkul\TimeOff\Filament\Clusters\Reporting\Resources\ByEmployeeResource::class                               => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any', 'approve'],
