...
class ProjectPolicy
{
    ...
    {
        if (! $user->can('update_project::project')) {
            return false;
        }
    ...
    {
        if (! $user->can('delete_project::project')) {
            return false;
        }
    ...
    {
        if (! $user->can('force_delete_project::project')) {
            return false;
        }
    ...
    {
        if (! $user->can('restore_project::project')) {
            return false;
        }
    ...
    {
        if (! $user->can('replicate_project::project')) {
            return false;
        }
